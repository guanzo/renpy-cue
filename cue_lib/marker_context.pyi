...
class CueMarkerContext:
    ...
    def add_folder(self, folder_path: str) -> Optional[str]: ...
    def send_file(self, file_index: int, record: bool = True) -> None: ...
    def send_folder(self, folder_path: str, record: bool = True) -> Optional[str]: ...
    ...
    def _clear_add_to_pool_warning(self) -> None: ...
...
class CueVideoContext(CueMarkerContext):
    ...
    def hook_level(self, group: str, ilevel_id: int) -> None: ...
    def send_preset(self, preset_name: str, record: bool = True) -> None: ...
    def clear(self) -> None: ...
    ...
    def _hook_level_on_pool(self, pool: Dict[str, Any], group: str, ilevel_id: int) -> None: ...
