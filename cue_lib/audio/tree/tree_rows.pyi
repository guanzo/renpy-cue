...
class CueTreeRowsBuilder:
    file_gap: int
    _tree: Any
    _rows_cache_key: Optional[tuple]
    _rows_cache: Optional[List[TreeRowDict]]
    _rows_cache_hits: int
    _rows_cache_builds: int
    ...
    def _memo_rows(self, key: tuple, build: Any) -> List[TreeRowDict]: ...
