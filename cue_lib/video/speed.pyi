...
class CueVidSpeedSequence:
    ...
    _auto_sequences: Dict[str, List[float]]
    ...
    def set_auto_sequence(self, tag: str, seq: List[float]) -> None: ...
...
class CueVidSpeedResolver:
    ...
    def banding_speeds(self, tag: str) -> Optional[List[float]]: ...
    def invalidate_speed_cache(self) -> None: ...
