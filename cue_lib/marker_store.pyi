...
class CueMarkerStore:
    ...
    def _get_or_create_entry(self, trigger_key: str) -> Any: ...
    def _ensure_pool(self, trigger_key: str, pool_index: int) -> PoolDict: ...
    def _add_file_to_pool(self, trigger_key: str, filename: str, pool_index: int = 0) -> None: ...
    def _remove_file_from_pool(self, trigger_key: str, file_index: int, pool_index: int = 0) -> None: ...
    def _stamp_preset(self, trigger_key: str, preset_name: str, pool_index: int = 0) -> None: ...
