...
init -999 python:
    ...
    from cue_lib.constants import (
        ...
        CUE_DISCORD, CUE_GITHUB, CUE_KOFI,
    ...
    from cue_lib.util import (
        ...
        _cue_log, _cue_open_in_os_file_explorer, _cue_resolve_files, _cue_pick_file, _cue_query_matches,
    ...
    from cue_lib.constants import (
        ...
        CUE_KEYMAP_TOGGLE_OVERLAY, CUE_KEYMAP_QUIT_RELAUNCH, CUE_KEYMAP_EXIT_REPLAY,
...
init -900 python:
    ...
    def _cue_wire_managers():
        ...
        replays = CueReplayLibrary(paths, marker_store)
