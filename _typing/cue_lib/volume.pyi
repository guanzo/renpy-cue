...
class CueVolumeManager:
    ...
    def get(self, entry: Optional[Dict[str, Any]], trigger_key: Optional[str] = None, pool_index: Optional[int] = None) -> float: ...
    ...
    def get_effective(self, entry: Optional[Dict[str, Any]], trigger_key: Optional[str] = None, pool_index: Optional[int] = None) -> float: ...
